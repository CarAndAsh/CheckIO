...
def count_occurrences(main_str: str, sub_str: str) -> int:
    if main_str and sub_str:
        res = 0
        slice_str = main_str.lower()
        while sub_str.lower() in slice_str:
            slice_str = slice_str[slice_str.find(sub_str.lower())+1:]
            res += 1
        return res
    return 0
...
print("Example:")
print(count_occurrences('apple apple apple', 'apple apple'))
